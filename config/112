...
var config = {
  ...
  support_email: 'happyzhong0618@gmail.com',

  // Footer Text / Copyright
  copyright: 'Copyright &copy; ' + new Date().getFullYear() + ' - <a href="https://www.xmu.edu.cn/">Powered by Ljz</a>',
